...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(
                                    ...
                                    searchable = True,
                                    style={'width' : '80%', 'padding' : 3, 'font-size': 30, 'text-align-last': 'center'}
                                ),
                                html.Br(),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site][['class']].value_counts().reset_index(name = "counts")
...
def get_scatter_plot(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(filtered_df, 
            ...
            y = 'class',
            color = 'Booster Version Category',
            title = 'Payload Mass vs. Success Rate for site {}'.format(entered_site))        
        return fig
